...
namespace Proxies\__CG__\EPSI\NewsBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class categorie extends \EPSI\NewsBundle\Entity\categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EPSI\\NewsBundle\\Entity\\categorie' . "\0" . 'id', '' . "\0" . 'EPSI\\NewsBundle\\Entity\\categorie' . "\0" . 'categorieName');
        }
