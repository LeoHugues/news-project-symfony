 ...
 */
class tag extends \EPSI\NewsBundle\Entity\tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EPSI\\NewsBundle\\Entity\\tag' . "\0" . 'id', '' . "\0" . 'EPSI\\NewsBundle\\Entity\\tag' . "\0" . 'intitule');
        }
